    ...
    const gradientStopOne = [
        { pct: 0,  color: { r: 0, g: 255, b: 106 } }, // The first color in your gradient
        { pct: 100, color: { r: 255, g: 0, b: 0 } }   // The color you want your first color to transition to
    ];
    const gradientStopTwo = [
        { pct: 0,  color: { r: 115, g: 0, b: 255 } }, // The second color in your gradient
        { pct: 100, color: { r: 187, g: 0, b: 255 } }  // The color you want your second color to transition to
    ]
    ...
    document.getElementById('fade-button').style.background = `linear-gradient(${angle}deg, rgb(${c1.r}, ${c1.g}, ${c1.b}), rgb(${c2.r}, ${c2.g}, ${c2.b}))`;
    ...
    document.getElementById('fade-button').addEventListener('mouseover', function() {
        animationDirection = 'forwards';
        animateGradient();
    });
    // On hover out, run our animation again, but backwards
    document.getElementById('fade-button').addEventListener('mouseleave', function() {
